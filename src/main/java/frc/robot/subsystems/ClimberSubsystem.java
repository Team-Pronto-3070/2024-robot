...
public class ClimberSubsystem extends SubsystemBase {
  ...
  public ClimberSubsystem() {
    leftMotor =
      new CANSparkMax(
        Constants.ClimberSubsystem.leftTalonID,
        MotorType.kBrushless
      );
    rightMotor =
      new CANSparkMax(
        Constants.ClimberSubsystem.rightTalonID,
        MotorType.kBrushless
      );
    ...
    leftMotor.setIdleMode(Constants.ClimberSubsystem.idleMode);
    rightMotor.setIdleMode(Constants.ClimberSubsystem.idleMode);
  }
  ...
  public void setLeftSpeed(double speed) {
    this.leftMotor.set(speed * Constants.ClimberSubsystem.maxSpeed);
  }
  ...
  public void setRightSpeed(double speed) {
    this.rightMotor.set(speed * Constants.ClimberSubsystem.maxSpeed);
  }
